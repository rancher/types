...
type Config struct {
	...
	GlobalDNSs                               map[string]managementClient.GlobalDNS                               `json:"globalDNSs,omitempty" yaml:"globalDNSs,omitempty"`
	Targets                                  map[string]managementClient.Target                                  `json:"targets,omitempty" yaml:"targets,omitempty"`
