...
var _ ResourceQuotaLister = &ResourceQuotaListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ ResourceQuotaController = &ResourceQuotaControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler ResourceQuotaHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler ResourceQuotaHandlerFunc)  {
...
//             },
//             ListerFunc: func() ResourceQuotaLister {
...
type ResourceQuotaControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Handler ResourceQuotaHandlerFunc
		}
...
func (mock *ResourceQuotaControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler ResourceQuotaHandlerFunc) {
...
func (mock *ResourceQuotaControllerMock) AddHandler(ctx context.Context, name string, handler ResourceQuotaHandlerFunc) {
...
func (mock *ResourceQuotaControllerMock) Lister() ResourceQuotaLister {
...
// If this is not the case, regenerate this file with moq.
var _ ResourceQuotaInterface = &ResourceQuotaInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync ResourceQuotaHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle ResourceQuotaLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync ResourceQuotaHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle ResourceQuotaLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() ResourceQuotaController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.ResourceQuota, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.ResourceQuota, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*ResourceQuotaList, error) {
// 	               panic("mock out the List method")
//             },
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *ResourceQuotaInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync ResourceQuotaHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle ResourceQuotaLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *ResourceQuotaInterfaceMock) AddHandler(ctx context.Context, name string, sync ResourceQuotaHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle ResourceQuotaLifecycle) {
...
func (mock *ResourceQuotaInterfaceMock) Controller() ResourceQuotaController {
...
func (mock *ResourceQuotaInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *ResourceQuotaInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *ResourceQuotaInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *ResourceQuotaInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.ResourceQuota, error) {
	if mock.GetFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.ResourceQuota, error) {
...
// List calls ListFunc.
func (mock *ResourceQuotaInterfaceMock) List(opts v1.ListOptions) (*ResourceQuotaList, error) {
	if mock.ListFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
