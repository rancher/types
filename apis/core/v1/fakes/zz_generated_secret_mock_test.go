...
var _ SecretLister = &SecretListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ SecretController = &SecretControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler SecretHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler SecretHandlerFunc)  {
...
func (mock *SecretControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddHandler(ctx context.Context, name string, handler SecretHandlerFunc) {
...
func (mock *SecretControllerMock) Lister() SecretLister {
...
// If this is not the case, regenerate this file with moq.
var _ SecretInterface = &SecretInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync SecretHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle SecretLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync SecretHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle SecretLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() SecretController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.Secret, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.Secret, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*SecretList, error) {
// 	               panic("mock out the List method")
//             },
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *SecretInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync SecretHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle SecretLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *SecretInterfaceMock) AddHandler(ctx context.Context, name string, sync SecretHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle SecretLifecycle) {
...
func (mock *SecretInterfaceMock) Controller() SecretController {
...
func (mock *SecretInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *SecretInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *SecretInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *SecretInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.Secret, error) {
	if mock.GetFunc == nil {
...
func (mock *SecretInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.Secret, error) {
...
// List calls ListFunc.
func (mock *SecretInterfaceMock) List(opts v1.ListOptions) (*SecretList, error) {
	if mock.ListFunc == nil {
...
func (mock *SecretInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
