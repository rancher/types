...
var _ ServiceAccountLister = &ServiceAccountListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ ServiceAccountController = &ServiceAccountControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler ServiceAccountHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler ServiceAccountHandlerFunc)  {
...
//             },
//             ListerFunc: func() ServiceAccountLister {
...
type ServiceAccountControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Handler ServiceAccountHandlerFunc
		}
...
func (mock *ServiceAccountControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler ServiceAccountHandlerFunc) {
...
func (mock *ServiceAccountControllerMock) AddHandler(ctx context.Context, name string, handler ServiceAccountHandlerFunc) {
...
func (mock *ServiceAccountControllerMock) Lister() ServiceAccountLister {
...
// If this is not the case, regenerate this file with moq.
var _ ServiceAccountInterface = &ServiceAccountInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync ServiceAccountHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle ServiceAccountLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync ServiceAccountHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle ServiceAccountLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() ServiceAccountController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.ServiceAccount, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.ServiceAccount, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*ServiceAccountList, error) {
// 	               panic("mock out the List method")
//             },
...
type ServiceAccountInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Sync ServiceAccountHandlerFunc
		}
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *ServiceAccountInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync ServiceAccountHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *ServiceAccountInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle ServiceAccountLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *ServiceAccountInterfaceMock) AddHandler(ctx context.Context, name string, sync ServiceAccountHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *ServiceAccountInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle ServiceAccountLifecycle) {
...
func (mock *ServiceAccountInterfaceMock) Controller() ServiceAccountController {
...
func (mock *ServiceAccountInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *ServiceAccountInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *ServiceAccountInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *ServiceAccountInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.ServiceAccount, error) {
	if mock.GetFunc == nil {
...
func (mock *ServiceAccountInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.ServiceAccount, error) {
...
// List calls ListFunc.
func (mock *ServiceAccountInterfaceMock) List(opts v1.ListOptions) (*ServiceAccountList, error) {
	if mock.ListFunc == nil {
...
func (mock *ServiceAccountInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
