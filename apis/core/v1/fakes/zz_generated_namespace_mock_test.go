...
var _ NamespaceLister = &NamespaceListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ NamespaceController = &NamespaceControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler NamespaceHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler NamespaceHandlerFunc)  {
...
//             },
//             ListerFunc: func() NamespaceLister {
...
func (mock *NamespaceControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler NamespaceHandlerFunc) {
...
func (mock *NamespaceControllerMock) AddHandler(ctx context.Context, name string, handler NamespaceHandlerFunc) {
...
func (mock *NamespaceControllerMock) Lister() NamespaceLister {
...
// If this is not the case, regenerate this file with moq.
var _ NamespaceInterface = &NamespaceInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync NamespaceHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle NamespaceLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync NamespaceHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle NamespaceLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() NamespaceController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.Namespace, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.Namespace, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*NamespaceList, error) {
// 	               panic("mock out the List method")
//             },
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *NamespaceInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync NamespaceHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *NamespaceInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle NamespaceLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *NamespaceInterfaceMock) AddHandler(ctx context.Context, name string, sync NamespaceHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *NamespaceInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle NamespaceLifecycle) {
...
func (mock *NamespaceInterfaceMock) Controller() NamespaceController {
...
func (mock *NamespaceInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *NamespaceInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *NamespaceInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *NamespaceInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.Namespace, error) {
	if mock.GetFunc == nil {
...
func (mock *NamespaceInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.Namespace, error) {
...
// List calls ListFunc.
func (mock *NamespaceInterfaceMock) List(opts v1.ListOptions) (*NamespaceList, error) {
	if mock.ListFunc == nil {
...
func (mock *NamespaceInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
