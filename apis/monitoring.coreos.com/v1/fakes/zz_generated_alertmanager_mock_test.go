...
var _ AlertmanagerLister = &AlertmanagerListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ AlertmanagerController = &AlertmanagerControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler AlertmanagerHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler AlertmanagerHandlerFunc)  {
...
//             },
//             ListerFunc: func() AlertmanagerLister {
...
type AlertmanagerControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Handler AlertmanagerHandlerFunc
		}
...
func (mock *AlertmanagerControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler AlertmanagerHandlerFunc) {
...
func (mock *AlertmanagerControllerMock) AddHandler(ctx context.Context, name string, handler AlertmanagerHandlerFunc) {
...
func (mock *AlertmanagerControllerMock) Lister() AlertmanagerLister {
...
// If this is not the case, regenerate this file with moq.
var _ AlertmanagerInterface = &AlertmanagerInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync AlertmanagerHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle AlertmanagerLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync AlertmanagerHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle AlertmanagerLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() AlertmanagerController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.Alertmanager, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.Alertmanager, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*AlertmanagerList, error) {
// 	               panic("mock out the List method")
//             },
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *AlertmanagerInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync AlertmanagerHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *AlertmanagerInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle AlertmanagerLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *AlertmanagerInterfaceMock) AddHandler(ctx context.Context, name string, sync AlertmanagerHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *AlertmanagerInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle AlertmanagerLifecycle) {
...
func (mock *AlertmanagerInterfaceMock) Controller() AlertmanagerController {
...
func (mock *AlertmanagerInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *AlertmanagerInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *AlertmanagerInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *AlertmanagerInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.Alertmanager, error) {
	if mock.GetFunc == nil {
...
func (mock *AlertmanagerInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.Alertmanager, error) {
...
// List calls ListFunc.
func (mock *AlertmanagerInterfaceMock) List(opts v1.ListOptions) (*AlertmanagerList, error) {
	if mock.ListFunc == nil {
...
func (mock *AlertmanagerInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
