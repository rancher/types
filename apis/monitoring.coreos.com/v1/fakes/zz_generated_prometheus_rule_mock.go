...
var (
	...
	lockPrometheusRuleInterfaceMockUpdateStatus                     sync.RWMutex
...
//             },
//             UpdateStatusFunc: func(in1 *v1.PrometheusRule) (*v1.PrometheusRule, error) {
...
func (mock *PrometheusRuleInterfaceMock) UpdateStatus(in1 *v1.PrometheusRule) (*v1.PrometheusRule, error) {
	if mock.UpdateStatusFunc == nil {
		panic("PrometheusRuleInterfaceMock.UpdateStatusFunc: method is nil but PrometheusRuleInterface.UpdateStatus was just called")
	}
	callInfo := struct {
		In1 *v1.PrometheusRule
	}{
	...
	lockPrometheusRuleInterfaceMockUpdateStatus.Lock()
	mock.calls.UpdateStatus = append(mock.calls.UpdateStatus, callInfo)
	lockPrometheusRuleInterfaceMockUpdateStatus.Unlock()
	return mock.UpdateStatusFunc(in1)
}

// UpdateStatusCalls gets all the calls that were made to UpdateStatus.
// Check the length with:
//     len(mockedPrometheusRuleInterface.UpdateStatusCalls())
func (mock *PrometheusRuleInterfaceMock) UpdateStatusCalls() []struct {
	In1 *v1.PrometheusRule
} {
	var calls []struct {
		In1 *v1.PrometheusRule
	}
	lockPrometheusRuleInterfaceMockUpdateStatus.RLock()
	calls = mock.calls.UpdateStatus
	lockPrometheusRuleInterfaceMockUpdateStatus.RUnlock()
	return calls
}
