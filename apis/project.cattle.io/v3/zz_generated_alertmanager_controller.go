...
func NewAlertmanager(namespace, name string, obj Alertmanager) *Alertmanager {
...
type AlertmanagerChangeHandlerFunc func(obj *Alertmanager) (runtime.Object, error)
...
func (s *alertmanagerClient) Patch(o *Alertmanager, patchType types.PatchType, data []byte, subresources ...string) (*Alertmanager, error) {
