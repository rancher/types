...
var _ PipelineLister = &PipelineListerMock{}
...
//             GetFunc: func(namespace string, name string) (*Pipeline, error) {
// 	               panic("mock out the Get method")
//             },
//             ListFunc: func(namespace string, selector labels.Selector) ([]*Pipeline, error) {
...
// Get calls GetFunc.
func (mock *PipelineListerMock) Get(namespace string, name string) (*Pipeline, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *PipelineListerMock) List(namespace string, selector labels.Selector) ([]*Pipeline, error) {
...
// If this is not the case, regenerate this file with moq.
var _ PipelineController = &PipelineControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler PipelineHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler PipelineHandlerFunc)  {
...
//             },
//             ListerFunc: func() PipelineLister {
...
func (mock *PipelineControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler PipelineHandlerFunc) {
...
func (mock *PipelineControllerMock) AddHandler(ctx context.Context, name string, handler PipelineHandlerFunc) {
...
func (mock *PipelineControllerMock) Lister() PipelineLister {
...
// If this is not the case, regenerate this file with moq.
var _ PipelineInterface = &PipelineInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync PipelineHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle PipelineLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync PipelineHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle PipelineLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() PipelineController {
// 	               panic("mock out the Controller method")
//             },
//             CreateFunc: func(in1 *Pipeline) (*Pipeline, error) {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*Pipeline, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*Pipeline, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*PipelineList, error) {
// 	               panic("mock out the List method")
//             },
//             ObjectClientFunc: func() *objectclient.ObjectClient {
// 	               panic("mock out the ObjectClient method")
//             },
//             UpdateFunc: func(in1 *Pipeline) (*Pipeline, error) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *PipelineInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync PipelineHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *PipelineInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle PipelineLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *PipelineInterfaceMock) AddHandler(ctx context.Context, name string, sync PipelineHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *PipelineInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle PipelineLifecycle) {
...
func (mock *PipelineInterfaceMock) Controller() PipelineController {
...
func (mock *PipelineInterfaceMock) Create(in1 *Pipeline) (*Pipeline, error) {
...
// Get calls GetFunc.
func (mock *PipelineInterfaceMock) Get(name string, opts v1.GetOptions) (*Pipeline, error) {
	if mock.GetFunc == nil {
...
func (mock *PipelineInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*Pipeline, error) {
...
// List calls ListFunc.
func (mock *PipelineInterfaceMock) List(opts v1.ListOptions) (*PipelineList, error) {
	if mock.ListFunc == nil {
...
func (mock *PipelineInterfaceMock) Update(in1 *Pipeline) (*Pipeline, error) {
