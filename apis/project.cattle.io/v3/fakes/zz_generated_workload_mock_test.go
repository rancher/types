...
var _ WorkloadLister = &WorkloadListerMock{}
...
//             GetFunc: func(namespace string, name string) (*Workload, error) {
// 	               panic("mock out the Get method")
//             },
//             ListFunc: func(namespace string, selector labels.Selector) ([]*Workload, error) {
...
// Get calls GetFunc.
func (mock *WorkloadListerMock) Get(namespace string, name string) (*Workload, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *WorkloadListerMock) List(namespace string, selector labels.Selector) ([]*Workload, error) {
...
// If this is not the case, regenerate this file with moq.
var _ WorkloadController = &WorkloadControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler WorkloadHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler WorkloadHandlerFunc)  {
...
//             },
//             ListerFunc: func() WorkloadLister {
...
func (mock *WorkloadControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler WorkloadHandlerFunc) {
...
func (mock *WorkloadControllerMock) AddHandler(ctx context.Context, name string, handler WorkloadHandlerFunc) {
...
func (mock *WorkloadControllerMock) Lister() WorkloadLister {
...
// If this is not the case, regenerate this file with moq.
var _ WorkloadInterface = &WorkloadInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync WorkloadHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle WorkloadLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync WorkloadHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle WorkloadLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() WorkloadController {
// 	               panic("mock out the Controller method")
//             },
//             CreateFunc: func(in1 *Workload) (*Workload, error) {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*Workload, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*Workload, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*WorkloadList, error) {
// 	               panic("mock out the List method")
//             },
//             ObjectClientFunc: func() *objectclient.ObjectClient {
// 	               panic("mock out the ObjectClient method")
//             },
//             UpdateFunc: func(in1 *Workload) (*Workload, error) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *WorkloadInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync WorkloadHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *WorkloadInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle WorkloadLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *WorkloadInterfaceMock) AddHandler(ctx context.Context, name string, sync WorkloadHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *WorkloadInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle WorkloadLifecycle) {
...
func (mock *WorkloadInterfaceMock) Controller() WorkloadController {
...
func (mock *WorkloadInterfaceMock) Create(in1 *Workload) (*Workload, error) {
...
// Get calls GetFunc.
func (mock *WorkloadInterfaceMock) Get(name string, opts v1.GetOptions) (*Workload, error) {
	if mock.GetFunc == nil {
...
func (mock *WorkloadInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*Workload, error) {
...
// List calls ListFunc.
func (mock *WorkloadInterfaceMock) List(opts v1.ListOptions) (*WorkloadList, error) {
	if mock.ListFunc == nil {
...
func (mock *WorkloadInterfaceMock) Update(in1 *Workload) (*Workload, error) {
