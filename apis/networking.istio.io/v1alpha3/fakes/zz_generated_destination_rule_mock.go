...
import (
	...
	v1alpha3a "github.com/rancher/types/apis/networking.istio.io/v1alpha3"
...
// Ensure, that DestinationRuleListerMock does implement DestinationRuleLister.
// If this is not the case, regenerate this file with moq.
var _ v1alpha3a.DestinationRuleLister = &DestinationRuleListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1alpha3a.DestinationRuleController = &DestinationRuleControllerMock{}
...
func (mock *DestinationRuleControllerMock) AddHandler(ctx context.Context, name string, handler v1alpha3a.DestinationRuleHandlerFunc) {
...
func (mock *DestinationRuleControllerMock) Lister() v1alpha3a.DestinationRuleLister {
...
var (
	...
	lockDestinationRuleInterfaceMockUpdateStatus                     sync.RWMutex
	lockDestinationRuleInterfaceMockWatch                            sync.RWMutex
)

// Ensure, that DestinationRuleInterfaceMock does implement DestinationRuleInterface.
// If this is not the case, regenerate this file with moq.
var _ v1alpha3a.DestinationRuleInterface = &DestinationRuleInterfaceMock{}
...
//             },
//             UpdateStatusFunc: func(in1 *v1alpha3.DestinationRule) (*v1alpha3.DestinationRule, error) {
...
// AddHandler calls AddHandlerFunc.
func (mock *DestinationRuleInterfaceMock) AddHandler(ctx context.Context, name string, sync v1alpha3a.DestinationRuleHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) Controller() v1alpha3a.DestinationRuleController {
...
// Get calls GetFunc.
func (mock *DestinationRuleInterfaceMock) Get(name string, opts v1.GetOptions) (*v1alpha3.DestinationRule, error) {
	if mock.GetFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) UpdateStatus(in1 *v1alpha3.DestinationRule) (*v1alpha3.DestinationRule, error) {
	if mock.UpdateStatusFunc == nil {
		panic("DestinationRuleInterfaceMock.UpdateStatusFunc: method is nil but DestinationRuleInterface.UpdateStatus was just called")
	}
	callInfo := struct {
		In1 *v1alpha3.DestinationRule
	}{
	...
	lockDestinationRuleInterfaceMockUpdateStatus.Lock()
	mock.calls.UpdateStatus = append(mock.calls.UpdateStatus, callInfo)
	lockDestinationRuleInterfaceMockUpdateStatus.Unlock()
	return mock.UpdateStatusFunc(in1)
}

// UpdateStatusCalls gets all the calls that were made to UpdateStatus.
// Check the length with:
//     len(mockedDestinationRuleInterface.UpdateStatusCalls())
func (mock *DestinationRuleInterfaceMock) UpdateStatusCalls() []struct {
	In1 *v1alpha3.DestinationRule
} {
	var calls []struct {
		In1 *v1alpha3.DestinationRule
	}
	lockDestinationRuleInterfaceMockUpdateStatus.RLock()
	calls = mock.calls.UpdateStatus
	lockDestinationRuleInterfaceMockUpdateStatus.RUnlock()
	return calls
}

// Watch calls WatchFunc.
func (mock *DestinationRuleInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that DestinationRulesGetterMock does implement DestinationRulesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1alpha3a.DestinationRulesGetter = &DestinationRulesGetterMock{}
