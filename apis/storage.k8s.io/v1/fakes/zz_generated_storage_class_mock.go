...
import (
	...
	v1a "github.com/rancher/types/apis/storage.k8s.io/v1"
...
// Ensure, that StorageClassListerMock does implement StorageClassLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.StorageClassLister = &StorageClassListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.StorageClassController = &StorageClassControllerMock{}
...
func (mock *StorageClassControllerMock) Lister() v1a.StorageClassLister {
...
var (
	...
	lockStorageClassInterfaceMockUpdateStatus                     sync.RWMutex
	lockStorageClassInterfaceMockWatch                            sync.RWMutex
)

// Ensure, that StorageClassInterfaceMock does implement StorageClassInterface.
// If this is not the case, regenerate this file with moq.
var _ v1a.StorageClassInterface = &StorageClassInterfaceMock{}
...
//             },
//             UpdateStatusFunc: func(in1 *v1.StorageClass) (*v1.StorageClass, error) {
...
func (mock *StorageClassInterfaceMock) Controller() v1a.StorageClassController {
...
// Get calls GetFunc.
func (mock *StorageClassInterfaceMock) Get(name string, opts v1b.GetOptions) (*v1.StorageClass, error) {
	if mock.GetFunc == nil {
...
func (mock *StorageClassInterfaceMock) UpdateStatus(in1 *v1.StorageClass) (*v1.StorageClass, error) {
	if mock.UpdateStatusFunc == nil {
		panic("StorageClassInterfaceMock.UpdateStatusFunc: method is nil but StorageClassInterface.UpdateStatus was just called")
	}
	callInfo := struct {
		In1 *v1.StorageClass
	}{
	...
	lockStorageClassInterfaceMockUpdateStatus.Lock()
	mock.calls.UpdateStatus = append(mock.calls.UpdateStatus, callInfo)
	lockStorageClassInterfaceMockUpdateStatus.Unlock()
	return mock.UpdateStatusFunc(in1)
}

// UpdateStatusCalls gets all the calls that were made to UpdateStatus.
// Check the length with:
//     len(mockedStorageClassInterface.UpdateStatusCalls())
func (mock *StorageClassInterfaceMock) UpdateStatusCalls() []struct {
	In1 *v1.StorageClass
} {
	var calls []struct {
		In1 *v1.StorageClass
	}
	lockStorageClassInterfaceMockUpdateStatus.RLock()
	calls = mock.calls.UpdateStatus
	lockStorageClassInterfaceMockUpdateStatus.RUnlock()
	return calls
}

// Watch calls WatchFunc.
func (mock *StorageClassInterfaceMock) Watch(opts v1b.ListOptions) (watch.Interface, error) {
...
// Ensure, that StorageClassesGetterMock does implement StorageClassesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.StorageClassesGetter = &StorageClassesGetterMock{}
