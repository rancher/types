...
var _ NetworkPolicyLister = &NetworkPolicyListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ NetworkPolicyController = &NetworkPolicyControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler NetworkPolicyHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler NetworkPolicyHandlerFunc)  {
...
//             },
//             ListerFunc: func() NetworkPolicyLister {
...
type NetworkPolicyControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Handler NetworkPolicyHandlerFunc
		}
...
func (mock *NetworkPolicyControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler NetworkPolicyHandlerFunc) {
...
func (mock *NetworkPolicyControllerMock) AddHandler(ctx context.Context, name string, handler NetworkPolicyHandlerFunc) {
...
func (mock *NetworkPolicyControllerMock) Lister() NetworkPolicyLister {
...
// If this is not the case, regenerate this file with moq.
var _ NetworkPolicyInterface = &NetworkPolicyInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync NetworkPolicyHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle NetworkPolicyLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync NetworkPolicyHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle NetworkPolicyLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() NetworkPolicyController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.NetworkPolicy, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.NetworkPolicy, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*NetworkPolicyList, error) {
// 	               panic("mock out the List method")
//             },
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *NetworkPolicyInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync NetworkPolicyHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle NetworkPolicyLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *NetworkPolicyInterfaceMock) AddHandler(ctx context.Context, name string, sync NetworkPolicyHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle NetworkPolicyLifecycle) {
...
func (mock *NetworkPolicyInterfaceMock) Controller() NetworkPolicyController {
...
func (mock *NetworkPolicyInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *NetworkPolicyInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *NetworkPolicyInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *NetworkPolicyInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.NetworkPolicy, error) {
	if mock.GetFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.NetworkPolicy, error) {
...
// List calls ListFunc.
func (mock *NetworkPolicyInterfaceMock) List(opts v1.ListOptions) (*NetworkPolicyList, error) {
	if mock.ListFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
