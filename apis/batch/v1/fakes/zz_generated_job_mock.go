...
var (
	...
	lockJobInterfaceMockUpdateStatus                     sync.RWMutex
...
//             },
//             UpdateStatusFunc: func(in1 *v1.Job) (*v1.Job, error) {
...
func (mock *JobInterfaceMock) UpdateStatus(in1 *v1.Job) (*v1.Job, error) {
	if mock.UpdateStatusFunc == nil {
		panic("JobInterfaceMock.UpdateStatusFunc: method is nil but JobInterface.UpdateStatus was just called")
	}
	callInfo := struct {
		In1 *v1.Job
	}{
	...
	lockJobInterfaceMockUpdateStatus.Lock()
	mock.calls.UpdateStatus = append(mock.calls.UpdateStatus, callInfo)
	lockJobInterfaceMockUpdateStatus.Unlock()
	return mock.UpdateStatusFunc(in1)
}

// UpdateStatusCalls gets all the calls that were made to UpdateStatus.
// Check the length with:
//     len(mockedJobInterface.UpdateStatusCalls())
func (mock *JobInterfaceMock) UpdateStatusCalls() []struct {
	In1 *v1.Job
} {
	var calls []struct {
		In1 *v1.Job
	}
	lockJobInterfaceMockUpdateStatus.RLock()
	calls = mock.calls.UpdateStatus
	lockJobInterfaceMockUpdateStatus.RUnlock()
	return calls
}
