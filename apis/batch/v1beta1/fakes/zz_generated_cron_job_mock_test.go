...
var _ CronJobLister = &CronJobListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ CronJobController = &CronJobControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler CronJobHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler CronJobHandlerFunc)  {
...
func (mock *CronJobControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler CronJobHandlerFunc) {
...
func (mock *CronJobControllerMock) AddHandler(ctx context.Context, name string, handler CronJobHandlerFunc) {
...
func (mock *CronJobControllerMock) Lister() CronJobLister {
...
// If this is not the case, regenerate this file with moq.
var _ CronJobInterface = &CronJobInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync CronJobHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle CronJobLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync CronJobHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle CronJobLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() CronJobController {
...
//             },
//             ListFunc: func(opts v1.ListOptions) (*CronJobList, error) {
// 	               panic("mock out the List method")
//             },
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *CronJobInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync CronJobHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *CronJobInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle CronJobLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *CronJobInterfaceMock) AddHandler(ctx context.Context, name string, sync CronJobHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *CronJobInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle CronJobLifecycle) {
...
func (mock *CronJobInterfaceMock) Controller() CronJobController {
...
// List calls ListFunc.
func (mock *CronJobInterfaceMock) List(opts v1.ListOptions) (*CronJobList, error) {
	if mock.ListFunc == nil {
