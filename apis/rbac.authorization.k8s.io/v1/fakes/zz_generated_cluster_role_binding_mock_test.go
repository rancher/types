...
var _ ClusterRoleBindingLister = &ClusterRoleBindingListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ ClusterRoleBindingController = &ClusterRoleBindingControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler ClusterRoleBindingHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler ClusterRoleBindingHandlerFunc)  {
...
//             },
//             ListerFunc: func() ClusterRoleBindingLister {
...
type ClusterRoleBindingControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Handler ClusterRoleBindingHandlerFunc
		}
...
func (mock *ClusterRoleBindingControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler ClusterRoleBindingHandlerFunc) {
...
func (mock *ClusterRoleBindingControllerMock) AddHandler(ctx context.Context, name string, handler ClusterRoleBindingHandlerFunc) {
...
func (mock *ClusterRoleBindingControllerMock) Lister() ClusterRoleBindingLister {
...
// If this is not the case, regenerate this file with moq.
var _ ClusterRoleBindingInterface = &ClusterRoleBindingInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync ClusterRoleBindingHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle ClusterRoleBindingLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync ClusterRoleBindingHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle ClusterRoleBindingLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() ClusterRoleBindingController {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*v1.ClusterRoleBinding, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*v1.ClusterRoleBinding, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*ClusterRoleBindingList, error) {
// 	               panic("mock out the List method")
//             },
...
type ClusterRoleBindingInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Sync ClusterRoleBindingHandlerFunc
		}
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *ClusterRoleBindingInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync ClusterRoleBindingHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle ClusterRoleBindingLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *ClusterRoleBindingInterfaceMock) AddHandler(ctx context.Context, name string, sync ClusterRoleBindingHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle ClusterRoleBindingLifecycle) {
...
func (mock *ClusterRoleBindingInterfaceMock) Controller() ClusterRoleBindingController {
...
func (mock *ClusterRoleBindingInterfaceMock) Delete(name string, options *v1.DeleteOptions) error {
...
func (mock *ClusterRoleBindingInterfaceMock) DeleteCollection(deleteOpts *v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (mock *ClusterRoleBindingInterfaceMock) DeleteNamespaced(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *ClusterRoleBindingInterfaceMock) Get(name string, opts v1.GetOptions) (*v1.ClusterRoleBinding, error) {
	if mock.GetFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*v1.ClusterRoleBinding, error) {
...
// List calls ListFunc.
func (mock *ClusterRoleBindingInterfaceMock) List(opts v1.ListOptions) (*ClusterRoleBindingList, error) {
	if mock.ListFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
