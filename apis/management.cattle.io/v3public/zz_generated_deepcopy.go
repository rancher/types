...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GSuiteProvider) DeepCopyInto(out *GSuiteProvider) {
	*out = *in
	in.SamlProvider.DeepCopyInto(&out.SamlProvider)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GSuiteProvider.
func (in *GSuiteProvider) DeepCopy() *GSuiteProvider {
	if in == nil {
		return nil
	}
	out := new(GSuiteProvider)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *GSuiteProvider) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
