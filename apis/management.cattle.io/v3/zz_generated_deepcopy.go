...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificatePKI) DeepCopyInto(out *CertificatePKI) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificatePKI.
func (in *CertificatePKI) DeepCopy() *CertificatePKI {
	if in == nil {
		return nil
	}
	out := new(CertificatePKI)
	in.DeepCopyInto(out)
	return out
}
