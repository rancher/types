...
import (
	kecattleiov1 "github.com/rancher/eks-controller/pkg/apis/ke.cattle.io/v1"
...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	...
	if in.EKSConfig != nil {
		...
		*out = new(kecattleiov1.EKSClusterConfigSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *EKSStatus) DeepCopyInto(out *EKSStatus) {
	*out = *in
	if in.GeneratedSubnets != nil {
		in, out := &in.GeneratedSubnets, &out.GeneratedSubnets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.GeneratedSecurityGroups != nil {
		in, out := &in.GeneratedSecurityGroups, &out.GeneratedSecurityGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
