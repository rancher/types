...
var _ GlobalRoleBindingLister = &GlobalRoleBindingListerMock{}
...
//             GetFunc: func(namespace string, name string) (*GlobalRoleBinding, error) {
// 	               panic("mock out the Get method")
//             },
//             ListFunc: func(namespace string, selector labels.Selector) ([]*GlobalRoleBinding, error) {
...
// Get calls GetFunc.
func (mock *GlobalRoleBindingListerMock) Get(namespace string, name string) (*GlobalRoleBinding, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *GlobalRoleBindingListerMock) List(namespace string, selector labels.Selector) ([]*GlobalRoleBinding, error) {
...
// If this is not the case, regenerate this file with moq.
var _ GlobalRoleBindingController = &GlobalRoleBindingControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler GlobalRoleBindingHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler GlobalRoleBindingHandlerFunc)  {
...
//             },
//             ListerFunc: func() GlobalRoleBindingLister {
...
type GlobalRoleBindingControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Handler GlobalRoleBindingHandlerFunc
		}
...
func (mock *GlobalRoleBindingControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler GlobalRoleBindingHandlerFunc) {
...
func (mock *GlobalRoleBindingControllerMock) AddHandler(ctx context.Context, name string, handler GlobalRoleBindingHandlerFunc) {
...
func (mock *GlobalRoleBindingControllerMock) Lister() GlobalRoleBindingLister {
...
// If this is not the case, regenerate this file with moq.
var _ GlobalRoleBindingInterface = &GlobalRoleBindingInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync GlobalRoleBindingHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle GlobalRoleBindingLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync GlobalRoleBindingHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle GlobalRoleBindingLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() GlobalRoleBindingController {
// 	               panic("mock out the Controller method")
//             },
//             CreateFunc: func(in1 *GlobalRoleBinding) (*GlobalRoleBinding, error) {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*GlobalRoleBinding, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*GlobalRoleBinding, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*GlobalRoleBindingList, error) {
// 	               panic("mock out the List method")
//             },
//             ObjectClientFunc: func() *objectclient.ObjectClient {
// 	               panic("mock out the ObjectClient method")
//             },
//             UpdateFunc: func(in1 *GlobalRoleBinding) (*GlobalRoleBinding, error) {
...
type GlobalRoleBindingInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedHandler []struct {
			...
			Sync GlobalRoleBindingHandlerFunc
		}
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *GlobalRoleBindingInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync GlobalRoleBindingHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *GlobalRoleBindingInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle GlobalRoleBindingLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *GlobalRoleBindingInterfaceMock) AddHandler(ctx context.Context, name string, sync GlobalRoleBindingHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *GlobalRoleBindingInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle GlobalRoleBindingLifecycle) {
...
func (mock *GlobalRoleBindingInterfaceMock) Controller() GlobalRoleBindingController {
...
func (mock *GlobalRoleBindingInterfaceMock) Create(in1 *GlobalRoleBinding) (*GlobalRoleBinding, error) {
...
// Get calls GetFunc.
func (mock *GlobalRoleBindingInterfaceMock) Get(name string, opts v1.GetOptions) (*GlobalRoleBinding, error) {
	if mock.GetFunc == nil {
...
func (mock *GlobalRoleBindingInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*GlobalRoleBinding, error) {
...
// List calls ListFunc.
func (mock *GlobalRoleBindingInterfaceMock) List(opts v1.ListOptions) (*GlobalRoleBindingList, error) {
	if mock.ListFunc == nil {
...
func (mock *GlobalRoleBindingInterfaceMock) Update(in1 *GlobalRoleBinding) (*GlobalRoleBinding, error) {
