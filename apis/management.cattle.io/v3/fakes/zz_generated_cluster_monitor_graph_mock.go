...
var (
	...
	lockClusterMonitorGraphInterfaceMockUpdateStatus                     sync.RWMutex
...
//             },
//             UpdateStatusFunc: func(in1 *v3.ClusterMonitorGraph) (*v3.ClusterMonitorGraph, error) {
...
func (mock *ClusterMonitorGraphInterfaceMock) UpdateStatus(in1 *v3.ClusterMonitorGraph) (*v3.ClusterMonitorGraph, error) {
	if mock.UpdateStatusFunc == nil {
		panic("ClusterMonitorGraphInterfaceMock.UpdateStatusFunc: method is nil but ClusterMonitorGraphInterface.UpdateStatus was just called")
	}
	callInfo := struct {
		In1 *v3.ClusterMonitorGraph
	}{
	...
	lockClusterMonitorGraphInterfaceMockUpdateStatus.Lock()
	mock.calls.UpdateStatus = append(mock.calls.UpdateStatus, callInfo)
	lockClusterMonitorGraphInterfaceMockUpdateStatus.Unlock()
	return mock.UpdateStatusFunc(in1)
}

// UpdateStatusCalls gets all the calls that were made to UpdateStatus.
// Check the length with:
//     len(mockedClusterMonitorGraphInterface.UpdateStatusCalls())
func (mock *ClusterMonitorGraphInterfaceMock) UpdateStatusCalls() []struct {
	In1 *v3.ClusterMonitorGraph
} {
	var calls []struct {
		In1 *v3.ClusterMonitorGraph
	}
	lockClusterMonitorGraphInterfaceMockUpdateStatus.RLock()
	calls = mock.calls.UpdateStatus
	lockClusterMonitorGraphInterfaceMockUpdateStatus.RUnlock()
	return calls
}
