...
var _ UserLister = &UserListerMock{}
...
//             GetFunc: func(namespace string, name string) (*User, error) {
// 	               panic("mock out the Get method")
//             },
//             ListFunc: func(namespace string, selector labels.Selector) ([]*User, error) {
...
// Get calls GetFunc.
func (mock *UserListerMock) Get(namespace string, name string) (*User, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *UserListerMock) List(namespace string, selector labels.Selector) ([]*User, error) {
...
// If this is not the case, regenerate this file with moq.
var _ UserController = &UserControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler UserHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler UserHandlerFunc)  {
...
func (mock *UserControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler UserHandlerFunc) {
...
func (mock *UserControllerMock) AddHandler(ctx context.Context, name string, handler UserHandlerFunc) {
...
func (mock *UserControllerMock) Lister() UserLister {
...
// If this is not the case, regenerate this file with moq.
var _ UserInterface = &UserInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync UserHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle UserLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync UserHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle UserLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() UserController {
// 	               panic("mock out the Controller method")
//             },
//             CreateFunc: func(in1 *User) (*User, error) {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*User, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*User, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*UserList, error) {
// 	               panic("mock out the List method")
//             },
//             ObjectClientFunc: func() *objectclient.ObjectClient {
// 	               panic("mock out the ObjectClient method")
//             },
//             UpdateFunc: func(in1 *User) (*User, error) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *UserInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync UserHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *UserInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle UserLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *UserInterfaceMock) AddHandler(ctx context.Context, name string, sync UserHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *UserInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle UserLifecycle) {
...
func (mock *UserInterfaceMock) Controller() UserController {
...
func (mock *UserInterfaceMock) Create(in1 *User) (*User, error) {
...
// Get calls GetFunc.
func (mock *UserInterfaceMock) Get(name string, opts v1.GetOptions) (*User, error) {
	if mock.GetFunc == nil {
...
func (mock *UserInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*User, error) {
...
// List calls ListFunc.
func (mock *UserInterfaceMock) List(opts v1.ListOptions) (*UserList, error) {
	if mock.ListFunc == nil {
...
func (mock *UserInterfaceMock) Update(in1 *User) (*User, error) {
