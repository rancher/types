...
var _ GlobalRoleLister = &GlobalRoleListerMock{}
...
//             GetFunc: func(namespace string, name string) (*GlobalRole, error) {
// 	               panic("mock out the Get method")
//             },
//             ListFunc: func(namespace string, selector labels.Selector) ([]*GlobalRole, error) {
...
// Get calls GetFunc.
func (mock *GlobalRoleListerMock) Get(namespace string, name string) (*GlobalRole, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *GlobalRoleListerMock) List(namespace string, selector labels.Selector) ([]*GlobalRole, error) {
...
// If this is not the case, regenerate this file with moq.
var _ GlobalRoleController = &GlobalRoleControllerMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler GlobalRoleHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, handler GlobalRoleHandlerFunc)  {
...
//             },
//             ListerFunc: func() GlobalRoleLister {
...
func (mock *GlobalRoleControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler GlobalRoleHandlerFunc) {
...
func (mock *GlobalRoleControllerMock) AddHandler(ctx context.Context, name string, handler GlobalRoleHandlerFunc) {
...
func (mock *GlobalRoleControllerMock) Lister() GlobalRoleLister {
...
// If this is not the case, regenerate this file with moq.
var _ GlobalRoleInterface = &GlobalRoleInterfaceMock{}
...
//             AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync GlobalRoleHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedHandler method")
//             },
//             AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle GlobalRoleLifecycle)  {
// 	               panic("mock out the AddClusterScopedLifecycle method")
//             },
//             AddHandlerFunc: func(ctx context.Context, name string, sync GlobalRoleHandlerFunc)  {
// 	               panic("mock out the AddHandler method")
//             },
//             AddLifecycleFunc: func(ctx context.Context, name string, lifecycle GlobalRoleLifecycle)  {
// 	               panic("mock out the AddLifecycle method")
//             },
//             ControllerFunc: func() GlobalRoleController {
// 	               panic("mock out the Controller method")
//             },
//             CreateFunc: func(in1 *GlobalRole) (*GlobalRole, error) {
...
//             },
//             GetFunc: func(name string, opts v1.GetOptions) (*GlobalRole, error) {
// 	               panic("mock out the Get method")
//             },
//             GetNamespacedFunc: func(namespace string, name string, opts v1.GetOptions) (*GlobalRole, error) {
// 	               panic("mock out the GetNamespaced method")
//             },
//             ListFunc: func(opts v1.ListOptions) (*GlobalRoleList, error) {
// 	               panic("mock out the List method")
//             },
//             ObjectClientFunc: func() *objectclient.ObjectClient {
// 	               panic("mock out the ObjectClient method")
//             },
//             UpdateFunc: func(in1 *GlobalRole) (*GlobalRole, error) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *GlobalRoleInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync GlobalRoleHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle GlobalRoleLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *GlobalRoleInterfaceMock) AddHandler(ctx context.Context, name string, sync GlobalRoleHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle GlobalRoleLifecycle) {
...
func (mock *GlobalRoleInterfaceMock) Controller() GlobalRoleController {
...
func (mock *GlobalRoleInterfaceMock) Create(in1 *GlobalRole) (*GlobalRole, error) {
...
// Get calls GetFunc.
func (mock *GlobalRoleInterfaceMock) Get(name string, opts v1.GetOptions) (*GlobalRole, error) {
	if mock.GetFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) GetNamespaced(namespace string, name string, opts v1.GetOptions) (*GlobalRole, error) {
...
// List calls ListFunc.
func (mock *GlobalRoleInterfaceMock) List(opts v1.ListOptions) (*GlobalRoleList, error) {
	if mock.ListFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) Update(in1 *GlobalRole) (*GlobalRole, error) {
