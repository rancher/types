...
type BitbucketServerPipelineConfig struct {
	...
	ConsumerKey     string            `json:"consumerKey,omitempty" yaml:"consumer_key,omitempty"`
	...
	PrivateKey      string            `json:"privateKey,omitempty" yaml:"private_key,omitempty"`
	ProjectID       string            `json:"projectId,omitempty" yaml:"project_id,omitempty"`
	PublicKey       string            `json:"publicKey,omitempty" yaml:"public_key,omitempty"`
