...
type GlobalVsphereOpts struct {
	...
	InsecureFlag      bool   `json:"insecure-flag,omitempty" yaml:"insecure_flag,omitempty"`
	Password          string `json:"password,omitempty" yaml:"password,omitempty"`
	RoundTripperCount int64  `json:"soap-roundtrip-count,omitempty" yaml:"soap_roundtrip_count,omitempty"`
	...
	VMName            string `json:"vm-name,omitempty" yaml:"vm_name,omitempty"`
	VMUUID            string `json:"vm-uuid,omitempty" yaml:"vm_uuid,omitempty"`
	WorkingDir        string `json:"working-dir,omitempty" yaml:"working_dir,omitempty"`
}
