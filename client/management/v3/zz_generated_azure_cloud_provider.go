...
const (
	...
	AzureCloudProviderFieldCloudProviderRateLimitBucketWrite = "cloudProviderRateLimitBucketWrite"
	AzureCloudProviderFieldCloudProviderRateLimitQPS         = "cloudProviderRateLimitQPS"
	AzureCloudProviderFieldCloudProviderRateLimitQPSWrite    = "cloudProviderRateLimitQPSWrite"
...
type AzureCloudProvider struct {
	...
	CloudProviderRateLimitBucketWrite int64  `json:"cloudProviderRateLimitBucketWrite,omitempty" yaml:"cloudProviderRateLimitBucketWrite,omitempty"`
	CloudProviderRateLimitQPS         int64  `json:"cloudProviderRateLimitQPS,omitempty" yaml:"cloudProviderRateLimitQPS,omitempty"`
	CloudProviderRateLimitQPSWrite    int64  `json:"cloudProviderRateLimitQPSWrite,omitempty" yaml:"cloudProviderRateLimitQPSWrite,omitempty"`
